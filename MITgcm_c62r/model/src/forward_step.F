C $Header: /u/gcmpack/MITgcm/model/src/forward_step.F,v 1.189 2011/01/18 21:04:35 heimbach Exp $
...
C--   Reset geometric factors to their current values
Cgf   (only has an impact for the adjoint)
#ifdef NONLIN_FRSURF
