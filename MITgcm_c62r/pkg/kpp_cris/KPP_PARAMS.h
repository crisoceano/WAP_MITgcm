...
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C 
C Turn minKPPhbl from a scalar variable into a 2D array variable
...
C
      _RL minKPPhbl     ( 1-OLx:sNx+OLx, 1-OLy:sNy+OLy,    nSx, nSy )
C%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
c     zmink    = minimum limit for zehat in table (m3/s3)
c     zmaxk    = maximum limit for zehat in table
...
c-----------------------------------------------------------------------
      ...
      _RL              deltaz,deltau,zmink,zmaxk,umink,umaxk
      common /kmixcws/ wmt, wst
     $               , deltaz,deltau,zmink,zmaxk,umink,umaxk
