...
c     zmi    = minimum limit for zehat in table (m3/s3)
c     zma    = maximum limit for zehat in table
...
C %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
C zmin and zmax variables changed to zmi and zma by Cris Schultz to
C avoid conflict with SEAICE and EXF variables called during other 
C KPP routines to implement Langmuir circulation/enhance mixing where 
C runoff is setup
C %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      _RL              wmt(0:nni+1,0:nnj+1), wst(0:nni+1,0:nnj+1)
      _RL              deltaz,deltau,zmi,zma,umin,umax
      common /kmixcws/ wmt, wst
     $               , deltaz,deltau,zmi,zma,umin,umax
