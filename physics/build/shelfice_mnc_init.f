C $Header: /u/gcmpack/MITgcm/pkg/shelfice/shelfice_mnc_init.F,v 1.1 2006/02/07 11:45:21 mlosch Exp $
...
CEOP
      ...
      IF (useMNC) THEN
        ...
        CALL MNC_CW_ADD_VATTR_TEXT('fwFlux','units','m/s', myThid)
