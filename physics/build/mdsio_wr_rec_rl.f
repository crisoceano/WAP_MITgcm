C $Header: /u/gcmpack/MITgcm/pkg/mdsio/mdsio_wr_rec_rl.F,v 1.2 2008/12/30 17:49:16 jmc Exp $
...
#ifdef REPRODUCE_BOTTOM_CTRL_OLDRESULTS
        WRITE( dUnit, rec=iRec ) arr
#else /* REPRODUCE_BOTTOM_CTRL_OLDRESULTS */
        DO k=1,nArr
          r8Buf(k) = arr(k)
        ENDDO
#ifdef _BYTESWAPIO
...
#endif /* REPRODUCE_BOTTOM_CTRL_OLDRESULTS */
      ELSE
        WRITE(msgBuf,'(A,I9)')
